					...
					<div class="row gx-lg-5 align-items-center">
						<div class="col-lg-6 mb-5 mb-lg-0">
							<h1 class="my-5 display-3 fw-bold ls-tight">
								Sign Up <br /> <span class="text-primary"> To Product
									App</span>
							</h1>
						...
						<div class="col-lg-6 mb-5 mb-lg-0">
							<div class="card">
								<div class="card-body py-5 px-md-5">
									<form action="processSignUpForm" method="post">
										<!-- 2 column grid layout with text inputs for the first and last names -->
										<div class="row">
											<div class="col-md-6 mb-4">
												<div class="form-outline">
													<label class="form-label" for="form3Example1">First
														name</label> <input type="text" id="form3Example1"
														class="form-control" placeholder="Enter your first name" name="firstName" required/>
											...
											<div class="col-md-6 mb-4">
												<div class="form-outline">
													<label class="form-label" for="form3Example2">Last
														name</label> <input type="text" id="form3Example2"
														class="form-control" placeholder="Enter your last name" name="lastName" required/>
										...
										<div class="form-outline mb-4">
											<label class="form-label" for="form3Example3">Email
												...
												class="form-control" placeholder="Enter your email" name="email" required/>
